<template>
  <v-app dark>
    <v-app-bar :clipped-left="clipped" fixed app color="indigo">
    ...
    <v-footer app class="pa-0">
      <v-row justify="center" no-gutters>
        <v-bottom-navigation v-model="bottomNav" class="green accent-4">
          <v-btn class="mx-1" dark icon fab block>
            <span class="white--text font-weight-bold">ثبت نظر سنجی</span>
          </v-btn>
        </v-bottom-navigation>
      </v-row>
    </v-footer>
